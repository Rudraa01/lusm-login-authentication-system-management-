...
// ─── Context ─────────────────────────────────────────────────────────────────
const AuthEasyContext = /*#__PURE__*/React.createContext(null);
...
function AuthEasyProvider({
  ...
  // ── Save session ────────────────────────────────────────────────────────────
  const _saveSession = React.useCallback(async (userData, accessToken, refreshToken) => {
...
function useAuthEasy() {
  const ctx = React.useContext(AuthEasyContext);
  if (!ctx) {
...
function AuthModal({
  ...
  return /*#__PURE__*/React.createElement(reactNative.Modal, {
  ...
  }, mode === 'login' ? 'Welcome back' : mode === 'signup' ? 'Create account' : 'Verify Email'), /*#__PURE__*/React.createElement(reactNative.Text, {
    style: [s.subtitle, {
      color: c.textMuted
    }]
  }, mode === 'otp' ? `${form.email} pe code bheja gaya` : mode === 'login' ? 'Sign in to continue' : 'Seconds mein join karo')), !!status.error && /*#__PURE__*/React.createElement(reactNative.View, {
    style: [s.alert, {
  ...
  }, status.error)), !!status.success && /*#__PURE__*/React.createElement(reactNative.View, {
    style: [s.alert, {
  ...
  }, status.success)), mode === 'login' && /*#__PURE__*/React.createElement(reactNative.View, {
    style: s.form
    ...
    onPress: handleLogin,
    c: c
  }, "Sign In"), /*#__PURE__*/React.createElement(reactNative.View, {
    style: s.switchRow
  }, /*#__PURE__*/React.createElement(reactNative.Text, {
    style: [s.switchText, {
      color: c.textMuted
    }]
  }, "Account nahi hai? "), /*#__PURE__*/React.createElement(reactNative.TouchableOpacity, {
    onPress: () => setMode('signup')
  }, /*#__PURE__*/React.createElement(reactNative.Text, {
    style: [s.switchLink, {
      color: c.accent
    }]
  }, "Sign up")))), mode === 'signup' && /*#__PURE__*/React.createElement(reactNative.View, {
    style: s.form
  }, /*#__PURE__*/React.createElement(RNField, {
    label: "Name",
    value: form.name,
    ...
    c: c
  }, "Create Account"), /*#__PURE__*/React.createElement(reactNative.View, {
    style: s.switchRow
  }, /*#__PURE__*/React.createElement(reactNative.Text, {
    style: [s.switchText, {
      color: c.textMuted
    }]
  }, "Account hai? "), /*#__PURE__*/React.createElement(reactNative.TouchableOpacity, {
    onPress: () => setMode('login')
  }, /*#__PURE__*/React.createElement(reactNative.Text, {
    style: [s.switchLink, {
      color: c.accent
    }]
  }, "Sign in")))), mode === 'otp' && /*#__PURE__*/React.createElement(reactNative.View, {
    style: s.form
    ...
    onPress: handleOtp,
    c: c
  }, "Verify & Login"), /*#__PURE__*/React.createElement(reactNative.View, {
    style: s.switchRow
  }, /*#__PURE__*/React.createElement(reactNative.Text, {
    style: [s.switchText, {
      color: c.textMuted
    }]
  }, "Code nahi mila? "), /*#__PURE__*/React.createElement(reactNative.TouchableOpacity, {
    onPress: handleResend
  }, /*#__PURE__*/React.createElement(reactNative.Text, {
    style: [s.switchLink, {
      color: c.accent
    }]
  }, "Resend karo")))), /*#__PURE__*/React.createElement(reactNative.Text, {
    style: [s.poweredBy, {
      color: c.textMuted
    }]
...
function RNField({
  ...
  }, label), /*#__PURE__*/React.createElement(reactNative.TextInput, _extends({
    placeholderTextColor: c.textMuted,
    style: [s.input, {
      backgroundColor: c.input,
      borderColor: c.inputBorder,
...
exports.AuthEasyProvider = AuthEasyProvider;
exports.AuthModal = AuthModal;
exports.useAuthEasy = useAuthEasy;
